...
bingoList[5] = [
  { name: "Stand on 10 Avalar Portals", types: ["silly"] },
...
bingoList[14] = [
  ...
  { name: "Complete 5 challenges that require you to beat them twice", types: ["orbs", "eggs"] },
  { name: "Collect 10000 gems", types: ["gems"] },
...
bingoList[17] = [
  { name: "Collect 200 gems in every Midday Gardens level", types: ["gems", "Midday Gardens", "Icy Peak", "Enchanted Towers", "Spooky Swamp", "Sgt. Byrd's Base", "Bamboo Terrace", "Country Speedway"] },
...
bingoList[20] = [
  { name: "Collect 250 gems in every Evening Lake level", types: ["gems", "Evening Lake", "Frozen Altars", "Fireworks Factory", "Lost Fleet", "Charmed Ridge", "Bentley's Outpost", "Honey Speedway"] },
...
bingoList[23] = [
  ...
  { name: "Collect 300 gems in 2 Midnight Mountain levels", types: ["gems", "Midnight Mountain", "Agent 9's Lab", "Crystal Island", "Desert Ruin"] },
  ...
  { name: "Collect 50 named Eggs", types: ["eggs"] }
];
bingoList[24] = [
...
bingoList[25] = [
  ...
  { name: "Complete 10 challenges that require you to beat them twice", types: ["orbs", "eggs"] },
  { name: "Save 60 Dragons", types: ["dragons"] }
];
